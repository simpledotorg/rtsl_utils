 ...
 Scenario: All patients should be hypertensive
  Given I create a new Patient on "2024-01-02" for this Facility with the following attributes
   | name                           |   |
   | does patient have hypertension | YES |
  Given That patient has a "Hypertension & Diabetes visit" event on "2024-01-02" with following data
